...
echo "=== Memperbarui cv.html: Structured Education, Competencies, Certifications & Dynamic Extras ==="
...
<body class="bg-slate-950 text-slate-100 antialiased min-h-screen flex flex-col justify-between selection:bg-blue-600 selection:text-white style-prestige" id="main-body">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div class="no-print lg:col-span-5 bg-slate-900/95 rounded-2xl border border-slate-800 p-4 sm:p-5 max-h-[85vh] overflow-y-auto relative shadow-xl">
        ...
        <div class="pt-2">
          ...
          <!-- FORM 4: KEAHLIAN & KOMPETENSI (DENGAN PRESET CEPAT) -->
          ...
          <!-- FORM 6: INFORMASI TAMBAHAN (BAHASA, PUBLIKASI, AFILIASI, DLL) -->
  ...
  <script>
    ...
    const STORAGE_KEY = 'gaeks_cv_master_list_v16';
          ...
          certificationsList: [
            {
              ...
              period: "Mastery Level / Professional",
              credentialId: "Oracle Certified Expert"
            },
            {
              name: "Microsoft Office Desktop Training",
              issuer: "Microsoft Partner Program",
              period: "Certified Professional",
              credentialId: "MS-DESK-2020"
            }
          ],
          extrasList: [
            {
              type: "Bahasa",
              details: "Bahasa Indonesia (Native), English (C1 Proficient - TOEFL IBT/PBT)"
            },
            {
              type: "Publikasi Ilmiah",
              details: "IEEE SIET 2017 Publication: Increased information retrieval capabilities on e-commerce websites using scraping techniques"
            }
          ],
          isPhotoEnabled: true,
          layout: 'prestige',
          ...
          educations: [
            {
              ...
              location: "Semarang, Central Java",
              degree: "Master of Information System (M.IS / 42 Credits Completed)",
              period: "Sept 2017 - Jan 2020",
              gpa: "Graduate Study Program",
              details: "Research Focus: Node.js & TCP/IP Architecture on Enterprise Linux Environment"
            },
            {
              ...
              gpa: "GPA 3.38 / 4.00 (Sangat Memuaskan)",
              details: "Best Research Paper Award IEEE SIET 2017: Web Information Retrieval via Advanced Scraping Techniques"
            }
          ]
        }
      };
    ...
    // FORM PENDIDIKAN TERSTRUKTUR (KAMPUS, LOKASI, GELAR, PERIODE, IPK/PREDIKAT, RISET)
    ...
    // FORM SERTIFIKASI & LISENSI RESMI (MODUL DINAMIS)
    ...
    // FORM INFORMASI TAMBAHAN (BAHASA, PUBLIKASI, AFILIASI, DLL)
    ...
    function renderCV() {
      ...
      function renderCategoryHeader(titleText) {
        if (activeLayout === 'prestige') {
          ...
          return `
            <div class="cv-section-title border-b-2 border-blue-900 pb-0.5 mb-2 mt-3 flex items-center gap-2">
          ...
          return `
            <div class="cv-section-title border-b border-slate-400 pb-0.5 mb-2 mt-3">
      ...
      // EDUCATIONS: TATA LETAK TERSTRUKTUR DENGAN PREDIKAT & RISET TIDAK TERPUTUS
      let educationsHTML = '';
      ...
      // SKILLS: MODULAR COMPETENCIES MATRIX
      let skillsGroupHTML = '';
      document.querySelectorAll('.skill-group-item').forEach(el => {
      ...
      // CERTIFICATIONS & LICENSES: MODUL TERSTRUKTUR SEJAJAR
      let certsHTML = '';
      ...
      // ADDITIONAL INFORMATION (EXTRAS): MODULAR SECTIONS
      let extrasHTML = '';
...
echo "=== Mem-push pembaruan Full Architecture ke GitHub ==="
git add cv.html
git commit -m "feat: complete overhaul of education layout, core competencies matrix, dynamic certifications and additional information modules" || true
