...
echo "=== Memperbarui cv.html dengan 526+ Bank Profesi & Live Search Engine ==="
...
<body class="bg-slate-950 text-slate-100 antialiased min-h-screen flex flex-col justify-between selection:bg-blue-600 selection:text-white style-prestige" id="main-body">
  ...
  <script>
    ...
    const STORAGE_KEY = 'gaeks_cv_master_list_v13';

    // GET ALL PROFESSIONS IN FLAT ARRAY
    ...
    // LIVE SEARCH & SECTOR FILTER ENGINE
...
echo "=== Mem-push pembaruan 526+ Profesi ke GitHub ==="
git add cv.html
git commit -m "feat: expand profession bank to 526+ roles with live search and drag-and-drop selector" || true
