...
echo "=== Memperbarui api/test_mail.php dengan Arsitektur Asynchronous AJAX ==="
...
git commit -m "fix: implement asynchronous AJAX email test to prevent browser 404 navigation" || true
git push origin main

echo "=== SELESAI! Refresh https://gdp.gaeks.com/api/test_mail.php dan klik tombol Kirim Email ==="
